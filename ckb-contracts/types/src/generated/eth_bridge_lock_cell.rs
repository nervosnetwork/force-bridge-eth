...
impl ::core::fmt::Display for ETHBridgeLockArgs {
    fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        ...
        write!(f, ", {}: {}", "typescript_hash", self.typescript_hash())?;
        write!(f, " }}")
    }
}
...
impl ETHBridgeLockArgs {
    ...
    pub const FIELD_SIZES: [usize; 3] = [20, 20, 32];
    ...
    pub fn typescript_hash(&self) -> Byte32 {
...
impl molecule::prelude::Entity for ETHBridgeLockArgs {
    ...
    fn as_builder(self) -> Self::Builder {
        Self::new_builder()
            ...
            .typescript_hash(self.typescript_hash())
    }
}
#[derive(Clone, Copy)]
...
impl<'r> ETHBridgeLockArgsReader<'r> {
    ...
    pub fn typescript_hash(&self) -> Byte32Reader<'r> {
...
pub struct ETHBridgeLockArgsBuilder {
    ...
    pub(crate) typescript_hash: Byte32,
}
impl ETHBridgeLockArgsBuilder {
    ...
    pub fn typescript_hash(mut self, v: Byte32) -> Self {
        self.typescript_hash = v;
        self
    }
}
impl molecule::prelude::Builder for ETHBridgeLockArgsBuilder {
    ...
    fn write<W: ::molecule::io::Write>(&self, writer: &mut W) -> ::molecule::io::Result<()> {
        ...
        writer.write_all(self.typescript_hash.as_slice())?;
        Ok(())
    }
