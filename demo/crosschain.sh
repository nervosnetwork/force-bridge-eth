...
${FORCE_CLI} transfer-from-ckb --config-path "${FORCE_CONFIG_PATH}" --ckb-privkey-path 0 --eth-privkey-path 2 --burn-amount 2 --unlock-fee 1 --receive-addr 0x403A53A7Dfa7a4AB022e53FeFf11232b3140407d   --token-addr ${ETH_ADDRESS} --wait
...
${FORCE_CLI} transfer-from-ckb --config-path "${FORCE_CONFIG_PATH}" --ckb-privkey-path 0 --eth-privkey-path 2 --burn-amount 2 --unlock-fee 1 --receive-addr 0x403A53A7Dfa7a4AB022e53FeFf11232b3140407d --wait --token-addr "${TOKEN_ADDRESS}"
